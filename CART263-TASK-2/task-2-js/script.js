...
//console.log(document.getElementsByClassName("img-image")[7]);
/***OUTPUT: * */
//<div class="img-container"> <img class="img-image" src="task-2-images/seventeen.png"> </div>
...
/***OUTPUT: * */ //<h2> The header of this fancy page</h2>
...
/***OUTPUT: * */
//script.js:60 <section id=​"parent">​flex<div class=​"inner-container">​…​</div>​<div class=​"inner-container">​…​</div>​<div class=​"inner-container">​…​</div>​<div class=​"inner-container">​…​</div>​<div class=​"inner-container">​…​</div>​<div class=​"inner-container">​…​</div>​<div class=​"inner-container">​…​</div>​<div class=​"inner-container">​…​</div>​</section>​
...
/***CODE */
//document.getElementById("1").innerHTML = "<p> New text in paragraph one: text changed by `your name` on the following date: `today's date`. </p>"
...
/***CODE */
//document.getElementsByTagName("p")[4].innerHTML += "<img class=newStyle src=task-2-images/one.png>"
...
//let innerContainers = getElementsByClassName("inner-container");
